<script setup>
import {exerciseDescriptions, workoutProgram} from "../../utils/index.js";
...
const { workout, warmup } = workoutProgram?.[Number(selectedWorkout) || 0] ?? { workout: [], warmup: [] };
  ...
  <section id="workout-card">
    ...
    <div class="workout-grid">
      ...
      <div class="workout-grid-line"></div>
        <h4 class="grid-name">Workouts</h4>
        <h6>Sets</h6>
        <h6>Reps</h6>
